...
def prepare(parent, project, source):
    ...
    copies = [(Path(__file__), 'driver.py'), (source / 'tools/native_u8_executor.py', 'executor.py'),
              (source / 'tools/native_u8_worker.py', 'runtime_worker.py'),
              (source / 'csl/programs/native_u8/kernel.csl', 'kernel.csl'),
