...
def prepare(stripes):
    ...
    reference=ROOT/'evidence/reference-f32/arithmetic';model=ROOT/'models/qwen2.5-0.5b-7ae5576'
    ...
    for src,dst in [(Path(__file__),'driver.py'),(ROOT/'tools/sdk_probe.py','executor.py'),(ROOT/'csl/kernels/kv_block_f32.csl','kv.csl'),(ROOT/'csl/runtime/line_statistics_f32.csl','line.csl'),(ROOT/'configs/precision.json','precision.json')]:shutil.copy2(src,out/dst)
