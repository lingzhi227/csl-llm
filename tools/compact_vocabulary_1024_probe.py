...
def prepare(parent, project, source, count, representation='packed', debug_info=True):
    if not 1 <= count <= 1024:
...
if __name__ == '__main__':
    ...
    if args.from_fixture:
        prepare(args.from_fixture.resolve(), args.project_root.resolve(), args.source_root.resolve(), args.tiles, args.representation, not args.no_debug_info)
    elif args.worker:
