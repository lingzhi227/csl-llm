...
def copy_sources(out):
    copies = [(Path(__file__), 'driver.py'), (ROOT / 'tools/sdk_probe.py', 'executor.py'),
              ...
              (ROOT / 'csl/programs/resident_mlp_dsd/pe.csl', 'pe.csl'),
              (ROOT / 'csl/programs/resident_mlp_dsd/kernel.csl', 'kernel.csl'),
              (ROOT / 'csl/programs/resident_mlp_dsd/vector.csl', 'vector.csl'),
              (ROOT / 'csl/programs/resident_mlp_dsd/line.csl', 'line.csl'),
              (ROOT / 'csl/programs/resident_mlp_dsd/input.csl', 'input.csl'),
              (ROOT / 'csl/programs/resident_mlp_dsd/packets.csl', 'packets.csl'),
