...
def copy_sources(out):
    copies = [(Path(__file__), 'driver.py'), (ROOT / 'tools/sdk_probe.py', 'executor.py'),
              ...
              (ROOT / 'csl/kernels/vector_f32.csl', 'vector.csl'),
              (ROOT / 'csl/runtime/line_allreduce_f32.csl', 'line.csl'),
              (ROOT / 'csl/runtime/filtered_input.csl', 'input.csl'),
              (ROOT / 'csl/runtime/packets.csl', 'packets.csl'),
              (ROOT / 'src/csl_llm/regions.py', 'regions.py'),
