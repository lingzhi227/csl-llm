...
def prepare(projection):
    ...
    for src,dst in [(Path(__file__),'driver.py'),(ROOT/'tools/sdk_probe.py','executor.py'),(ROOT/'csl/kernels/local_gemv_bf16_f32_colmajor.csl','kernel.csl'),(ROOT/'csl/runtime/line_allreduce_f32.csl','line.csl'),(ROOT/'configs/precision.json','precision.json'),(ROOT/'src/csl_llm/regions.py','regions.py')]:shutil.copy2(src,out/dst)
