...
S3 stateful causal GQA is under active development and excluded from the completed-component source selection. S4 complete layer, S5 complete model generation and S6 capacity/performance acceptance remain pending. No model-generated tokens from a complete CSL pipeline are claimed.
