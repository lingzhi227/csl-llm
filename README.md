...
Twenty-eight published static model-weight partitions independently qualify original blocks **0–28159 of 34552**, including whole-ELF compatibility. They are not a fully assembled or executed model. [Partition evidence and tools](docs/MODEL-PARTITIONS.md).
